...
export default function info() {
  return (
    <section className="bg-zinc-100 py-8 pb-12 mt-16">
      <div className="w-9/10 mx-auto">
        <div className="lg:translate-y-8">
          <p className="lg:text-3xl">
            کشف شیک پوشی با{" "}
            <span className="text-praimary mb-2">رگــــــــال</span>
          </p>
          ...
          <div className="lg:w-4/6 my-6 flex items-center flex-wrap gap-4">
            <div className="flex items-center justify-between gap-2">
              <div>
                ...
                <h3 className="mt-2 mb-4 font-bold text-sm font-yekan-Regular">
                  طراحی منحصر به فرد
                </h3>
